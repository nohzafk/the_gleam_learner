...
pub fn check_theta_and_gradient_lossely(f) {
  fn(t, answers, gradients) {
    ...
    gradient_of(f, t) |> is_tensor_equal(gradients) |> should.be_true
  }
}
